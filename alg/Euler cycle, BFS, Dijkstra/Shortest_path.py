...
The first line of the input contains three integers n, s and f (1 ≤ n ≤ 2000, 1 ≤ s, f ≤ n) — the number of vertices, the start vertex and the end vertex. Next n lines contain n integers each — the adjacency matrix of the graph, where  - 1 means non-existence of an edge. The weight of each edge does not exceed 109. The main diagonal contains only zeros.
Output
